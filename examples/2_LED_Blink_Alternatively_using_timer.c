...
#define LED_PIN2 GPIO_Pin_2  //PD2
...
void TIM2_IRQHandler(void)
{
    if (TIM_GetITStatus(TIM2, TIM_IT_Update) != RESET)
    {
        ...
        printf("TIM2 Interrupt Triggered! for LED1\r\n");
        GPIO_WriteBit(GPIOD, LED_PIN2, (BitAction)(!GPIO_ReadOutputDataBit(GPIOD, LED_PIN2)));
        /* Debug print */
        printf("TIM2 Interrupt Triggered!for LED2\r\n");
    }
}
